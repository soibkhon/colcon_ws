...
def generate_launch_description():
    ...
    ## Realsense mounted on the side of the wheelchair calibrated:
    ...
    #     name='static_transform_base',
    #     arguments=[
    #         '--x', '0.43', '--y', '0.25', '--z', '0.45',
    #         '--yaw', '0', '--pitch', '0.349066', '--roll', '0',
    #         '--frame-id', 'base_link',
    ...
    # Realsense mounted on top section of the wheelchair calibrated:
